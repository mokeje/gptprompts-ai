...
export const metadata: Metadata = {
  title: "Complete Prompts Library — 300+ AI Prompt Guides | GPTPrompts.AI",
  description:
    "Browse all 300+ AI prompt guides on GPTPrompts.AI. Find expert resources for ChatGPT, Claude, Gemini, Midjourney, prompt engineering techniques, image generation, career writing, and more.",
